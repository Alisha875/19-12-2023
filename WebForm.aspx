<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm.aspx.cs" Inherits="Assignment8.WebForm" %>
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="TxtName" ErrorMessage="Name must have at least 6 characters" OnServerValidate="CustomValidator1_ServerValidate" ForeColor="Red"></asp:CustomValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Button ID="BtnReg" runat="server" Text="Register Customer" OnClick="BtnReg_Click" />
                    </td>
                </tr>
            </table>
        </div>
